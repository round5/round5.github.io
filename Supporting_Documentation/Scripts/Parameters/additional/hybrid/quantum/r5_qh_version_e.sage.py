...
_sage_const_999999999 = Integer(999999999); _sage_const_256 = Integer(256); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_512 = Integer(512); _sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_12 = Integer(12)

...
def find_r_quantum_improved(n, q, m, h_weight, sigma, secret_structure = 'random_binary', bkzmodel = 'sieve', nr_rotations = 1, scaling = True, size_S = 1, k_vals = [100], print_results = False, preci = 1, verbose = False):
	global time_map
	time_map = {}
